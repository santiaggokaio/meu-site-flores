...
/**
 * Função helper para obter as FAQs em Server Components.
 * Retorna ReadonlyArray para preservar imutabilidade.
 */
export async function getFaqs(): Promise<ReadonlyArray<FaqItem>> {
  // Se em algum ponto precisar de array mutável, use [...faqs] aqui.
  return faqs;
}
